...
class GroceriesControllerTest < ActionController::TestCase
  ...
  test "should create grocery" do
    assert_difference('Grocery.count') do
      post :create, grocery: { productdiscription: @grocery.productdiscription, productid: @grocery.productid, productname: @grocery.productname }
    end
  ...
  test "should update grocery" do
    patch :update, id: @grocery, grocery: { productdiscription: @grocery.productdiscription, productid: @grocery.productid, productname: @grocery.productname }
    assert_redirected_to grocery_path(assigns(:grocery))
  end
